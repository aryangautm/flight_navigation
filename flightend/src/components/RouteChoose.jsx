  ...
  if ("error" in routes) {
    ...
    return (
      <div className="flex justify-center items-center">
        <h3 className="font-extrabold text-12px sm:text-1xl md:text-2xl text-center leading-[55px] sm:leading-[10px] md:leading-[30px] text-gradient2" >
          {routes.error.substring(0, routes.error.length - 1).toUpperCase() + "!"}
        </h3>
      </div>
    )
  }
